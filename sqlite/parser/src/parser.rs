use crate::ast::{
    ...
    CreateTableBody, CreateTypeBody, CreateVirtualTable, DeferSubclause, Distinctness,
    DomainConstraint, EqpFormat, Expr, ForeignKeyClause, FrameBound, FrameClause, FrameExclude,
    FrameMode, FromClause, FunctionTail, GeneratedColumnType, GroupBy, Indexed, IndexedColumn,
...
impl<'a> Parser<'a> {
    ...
    fn parse_drop_stmt(&mut self) -> Result<Stmt> {
        ...
        let tok =
            peek_expect!(self, TK_TABLE, TK_INDEX, TK_TRIGGER, TK_VIEW, TK_TYPE, TK_ID, TK_SERVER);
