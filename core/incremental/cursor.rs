...
impl MaterializedViewCursor {
    ...
    /// output delta.
    fn compute_upstream_outputs(&mut self) -> IOResultOr<rustc_hash::FxHashMap<String, Delta>> {
    ...
    fn materialize_index_snapshot(&mut self) -> IOResultOr<()> {
    ...
    fn next_index_organized(&mut self) -> IOResultOr<bool> {
